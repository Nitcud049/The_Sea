    ...
    if (orders) {
      orders.forEach(order => {
        if (order.status === 'completed') {
          ...
          if (year === currentYear) {
            monthly[month].revenue += order.total || 0;
            monthly[month].productsSold += itemsCount;
          }
        }
      });
    }
                            ...
                            >
                              ...
                              <button
                                ...
                                onMouseEnter={event => {
                                  ...
                                  event.currentTarget.style.color = '#ff4757';
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {hUser?.email || hUser?.username || 'N/A'}
                          </div>
                        </div>
